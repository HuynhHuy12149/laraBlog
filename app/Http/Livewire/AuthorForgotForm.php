...
class AuthorForgotForm extends Component
{
    ...
    public function ForgotHandler(){
        ...
        $body_message="We are received a request to reset the password for <b>LaraBlog</b> account associated with ".$this->email.". <br> You can reset  your password by clicking the buuton below.";
        $body_message.='<br>';
