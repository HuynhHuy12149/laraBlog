...
@section('pageTitle', @isset($pageTitle) ? $pageTitle : 'Login user')
@section('content')
        ...
        <div class="card-body">
            ...
            <form action="login" method="post" autocomplete="off" novalidate="">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Enter email or username" name="login_id"
                        autocomplete="off">
                    @error('login_id')
    ...
    @if (session()->has('user'))
        @php
           abort(403, 'You have already logged in');
        @endphp
    @else
